...
(function () {
  ...
  var defaults = {
    messageLocales: {
      ...
      oc:
        "Utilizam de cookies per vos provesir la melhora experiéncia possibla sus nòstre site web. Se contunhatz d'utilizar aqueste site web considerarem que sètz d'acòrdi amb aquò.",
      fr:
      ...
      id:
        "Kami menggunakan cookie untuk memastikan Anda mendapatkan pengalaman terbaik di situs web kami. Jika Anda terus menggunakan situs ini, kami berasumsi bahwa Anda akan senang dengannya.",
    },
