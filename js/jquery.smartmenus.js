  ...
  $.extend($.SmartMenus, {
    ...
    prototype: {
      ...
      menuScroll: function ($sub, once, step) {
        ...
        if (
          mouse &&
          ((data.up && newY > data.downEnd) || (!data.up && newY < data.upEnd))
        ) {
        ...
        if (mouse) {
          if (
            ...
            $sub
              .dataSM("scroll-arrows")
              .eq(0)
              .css("margin-top", data.upEnd)
              .end()
              .eq(1)
              .css("margin-top", data.downEnd + data.subH - data.arrowDownH)
              .end()
            ...
            if (/(start|down)$/i.test(e.type)) {
              ...
              if (prevY !== undefined && prevY != touchPoint.pageY) {
                ...
                $.extend(data, {
                  ...
                  touchTimestamp: e.timeStamp,
                  velocity:
                    data.velocity + Math.abs(touchPoint.pageY - prevY) * 0.5,
                });
              ...
              if (data.touchY !== undefined) {
                ...
                if (
                  e.timeStamp - data.touchTimestamp < 120 &&
                  data.velocity > 0
                ) {
                  data.velocity *= 0.5;
                  this.menuScrollStop($sub);
            ...
            if (this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth) {
              ...
              if (this.opts.subMenusMaxWidth) {
                ...
                if (noMaxWidth > this.getWidth($sub)) {
                  $sub.removeClass("").css("width", this.opts.subMenusMaxWidth);
                }
              }
            }
 ...
 * http://www.smartmenus.org/
 * Copyright 2015 Vasil Dinkov, Vadikom Web Ltd. http://vadikom.com; Licensed MIT */ (function (
  t
) {
  t(function () {
          ...
          (i.isCollapsible()
            ? (e.addClass("sm-collapsible"),
              e.is("[data-sm-skip-collapsible-behavior]") ||
                o.addClass("navbar-toggle sub-arrow"))
            : (e.removeClass("sm-collapsible"),
              e.is("[data-sm-skip-collapsible-behavior]") ||
                o.removeClass("navbar-toggle sub-arrow")),
          (a = t));
      }
      var e = t(this);
      e.addClass("sm")
