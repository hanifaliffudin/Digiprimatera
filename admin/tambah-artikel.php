...
if(isset($_POST['submit-btn'])){
    ...
    $add_artikel = $lib->add_data($banner, $thumbnail, $judul, $tanggal, $konten, $keyword, $description);
    if($add_artikel){
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img id="bannerPreview" src="" height="100px"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img id="thumbnailPreview" src="" height="100px"/>
                  </div>
                </div>
