...
if(isset($_POST['update-btn'])){
    ...
    $proyek_update = $lib->update($id ,$gambar, $proyek, $deskripsi);
    if($proyek_update)
    {
        header('Location:index-proyek.php');
    }else{
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  <label for="gambar" class="col-sm-2 control-label form-label">Gambar</label>
                  <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input
                        ...
                        name="proyek"
                        required
                        value="<?php echo $data_proyek['judul']; ?>"
                      />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Deskripsi</label>
                    <div class="col-sm-10">
                      <p>
                        <textarea
                          ...
                          name="deskripsi"
                        >
                        <?php echo $data_proyek['deskripsi']; ?>
                      </textarea
                        >
                      </p>
                    </div>
