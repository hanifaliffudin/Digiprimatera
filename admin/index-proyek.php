...
include('crud.php');
$lib = new Proyek();
$data_proyek = $lib->show();
 
if(isset($_GET['hapus_proyek']))
{
    $id_proyek = $_GET['hapus_proyek'];
    $status_hapus = $lib->delete($id_proyek);
    if($status_hapus)
    {
        header('Location: index-proyek.php');
    }else{
      echo "gagal";
    }
}
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <a href="tambah-proyek.php" class="btn btn-success">Tambah</a>
                ...
                <table class="table table-hover">
                  ...
                  <?php 
                    ...
                    foreach($data_proyek as $row)
                    {
                        ...
                        echo "<td><img class='img-fluid' style='width:100px;' src='data:image/png;base64,".base64_encode($row['gambar'])." alt=''></td>";
                        echo "<td>".$row['judul']."</td>";
                        echo "<td>".$row['deskripsi']."</td>";
                        echo "<td><a class='btn btn-info' href='edit-proyek.php?id=".$row['id']."'>Update</a>
                        <a class='btn btn-danger' href='index-proyek.php?hapus_proyek=".$row['id']."'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
